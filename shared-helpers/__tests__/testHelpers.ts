...
export const application: Application = {
  ...
  submissionDate: new Date(2021, 11, 2),
  ...
  preferences: [
    {
      ...
      options: [
        {
          key: "At least one member of my household works in the city",
          checked: true,
          extraData: [
            {
        ...
        {
          key: "All members of the household work in the city",
          checked: true,
          extraData: [
            {
              type: InputType.address,
        ...
        {
          key: "I don't want this preference",
          checked: false,
          extraData: [],
        },
      ],
    ...
    {
      multiselectQuestionId: "f9374988-44a3-405d-a7c2-96d5ec0f1b67",
      key: "City Employees",
      claimed: true,
      options: [
        {
  ...
  programs: [
    {
      multiselectQuestionId: "91a4ae0e-0c8e-4c8d-ac40-72439ae3ea62",
      key: "Veteran",
      claimed: true,
      options: [
        {
    ...
    byUnitTypeAndRent: [
      {
        ...
        rentAsPercentIncomeRange: { min: 10, max: 30 },
        totalAvailable: 5,
